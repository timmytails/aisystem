...
export default function Signup() {
    ...
    return (
        <div className='min-h-screen bg-[#F8F7F4] text-slate-900 lg:grid lg:min-h-screen lg:grid-cols-12'>

            {/* Left Photo Panel (Desktop) */}
            <div className='relative hidden h-full overflow-hidden bg-[#0F172A] lg:col-span-5 lg:block xl:col-span-4'>
                <img
                    src={loginImage}
                    ...
                    <div className='rounded-xl border border-slate-200 bg-white p-6 sm:p-10'>
                        ...
                        {step === 'details' ? (
                            <>
                                ...
                                {/* Divider */}
                                <div className='my-6 flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest text-slate-400'>
                                ...
                                <form onSubmit={requestOtp} className='space-y-4'>
                                    ...
                                    <div className='rounded-lg border border-slate-200 bg-slate-50 p-5'>
                                        <h2 className='font-serif text-base font-bold text-slate-900'>Home Address</h2>
                                        <p className='mt-0.5 text-xs text-slate-500'>Used for appointment confirmation.</p>
                            ...
                            <form onSubmit={verifyOtp} className='mt-6 space-y-4'>
                                <div className='rounded-lg border border-[#C25E2B]/30 bg-[#C25E2B]/10 p-4 text-sm font-medium text-slate-900'>
